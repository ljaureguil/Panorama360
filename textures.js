...
function Box(name,w,l,h,c){
    ...
    var s=name+"_Box";
    m.name={name:s,w:w,l:l,h:h,x:0,y:0,z:0,rx:0,ry:0,rz:0,rpx:1,rpy:1,ofx:0,ofy:0,rot:0,piv:c,anim:move,pic:art[5].pic}
    return  m;
}
function Sphere(name,r,sx,sy,c){ 
    ...
    var s=name+"_Sphere";
    m.name={name:s,r:r,sx:sx,sy:sy,x:0,y:0,z:0,rx:0,ry:0,rz:0,rpx:1,rpy:1,ofx:0,ofy:0,rot:0,piv:c,anim:move,pic:art[5].pic}
    return  m;
}
function Cylinder(name,r1,r2,h,s,cap,c){
 ...
 m.name={name:ss,r1:r1,r2:r2,h:h,s:s,cap:cap,x:0,y:0,z:0,rx:0,ry:0,rz:0,rpx:1,rpy:1,ofx:0,ofy:0,rot:0,piv:c,anim:move,pic:art[5].pic}
...
function Torus(name,r,tk,rs,ts,c){
    ...
    var s=name+"_Torus";
 m.name={name:s,r:r,tk:tk,rs:rs,ts:ts,x:0,y:0,z:0,rx:0,ry:0,rz:0,rpx:1,rpy:1,ofx:0,ofy:0,rot:0,piv:c,anim:move,pic:art[5].pic}
 return  m;
}
